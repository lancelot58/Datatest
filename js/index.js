$(function () {
    ...
    function echart_1() {
        ...
        var xAxisData = ['2月', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '3月26日', '', '', '', '', ''];
        var legendData = [ '2-3月'];
        var title = "Motoko 地板价";//标题
        var serieData = [];
        var metaDate = [
            [14, 14, 13, 15, 15, 19, 19, 19, 19, 20, 20, 22, 24, 25, 29, 25, 29, 31, 31, 28, 30, 32, 39, 42, 49, 57, 50, 50, 35, 39,30, 32, 35, 36, 35, 40, 39, 36, 34, 33, 25, 29, 28, 25, 24, 23, 27, 33, 28, 31, 28, 26, 26, 27, 26, 25]
        ]
    ...
    function echart_2() {
        ...
        myChart.setOption({
            ...
            yAxis: {
                type: 'category',
                data: ['BTCflower', 'Poked bots', 'Motoko', 'ICpunks', 'CC'],
                axisTick: {
                    show: false
                },
                splitLine: {
